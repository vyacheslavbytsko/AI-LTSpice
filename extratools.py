...
def get_netlist_b64_for_bessel_highpass_filter_tool():
    def bessel_high_pass(f, Z, n):
        id_of_scheme = str(uuid.uuid4())[:4]
    ...
    return StructuredTool.from_function(
        name="get_netlist_b64_for_butterworth_lowpass_filter",
        description="Возвращает base64 репрезентацию netlist для фильтра верхних частот Бесселя.",
        args_schema=GetNetlistInput,
        func=bessel_high_pass
    )
