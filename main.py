...
system_message = SystemMessage("Ты инженер LTSpice. Спроси у пользователя, "
                               ...
                               "преобразуй final netlist в .asc файл, отправь пользователю netlist, "
                               "отправь пользователю .asc файл, затем напиши пользователю сообщение "
                               "в духе \"Ура, всё получилось!\". "
