...
system_message = SystemMessage("Ты инженер LTSpice. Спроси у пользователя, "
                               ...
                               "получи netlist'ы каждой схемы, объедини эти netlist'ы в один netlist, "
                               "примени к netlist'у изначальные параметры и получи final netlist, "
                               "отправь готовый netlist пользователю, преобразуй final netlist "
                               "в .asc файл и отправь .asc файл пользователю, затем напиши пользователю "
                               "сообщение в духе \"Ура, всё получилось!\". Используй доступные инструменты. "
